function H = plotcleanup(hAx,hLine1,hLine2,ylabelon, yylabelon, adjustx, shallow)
...
xlim(hAx(1),[datenum('4-1-2014') datenum('7-1-2016')]); 
xlim(hAx(2),[datenum('4-1-2014') datenum('7-1-2016')]);
set(hAx(1),'Xgrid','on')
set(hAx(1),'FontSize',14)
set(gca,'xcolor',[0 0 0])
...
if adjustx == 1
    ...
    set(gca,'xcolor',[0 0 0])
    %set(gca,'Xtick',out2);
    set(gca,'XTick',linspace(datenum('04-01-2014'),datenum('07-01-2016'),28)); 
    set(gca,'XTickLabel', ...
        {'A','', 'J','','A','', 'O','','D','', 'F','', 'A', '','J', '', ...
        'A', '', 'O', '', 'D',  '', 'F', '','A', '', 'J',''});
